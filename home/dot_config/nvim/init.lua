...
-- Disabled python3 provider it may have some problems on my system
vim.g.loaded_python3_provider = 0

-- Set to true if you have a Nerd Font installed and selected in the terminal
vim.g.have_nerd_font = true

-- Filetypes which do not get lualine, indent-blankline or bufferline or
-- any other special plugin modification
...
-- Toggle spell check
vim.keymap.set("n", "<leader>sc", "<cmd>set spell!<CR>", { desc = "Toggle [s]pell [c]heck" })
...
-- Disable cursor blink in terminal mode
-- Removed t:block-blinkon500-blinkoff500-TermCursor from the string
